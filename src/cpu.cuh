...
void CPU::convertRgb2Gray(uchar3 *inPixels, int width, int height, int *out)
{
...
void CPU::calConvolution(int *grayPixels, int width, int height, float *filter, int filterWidth, int *outPixels)
{
